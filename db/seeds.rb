...
10.times do 
    Birth.create!(
    first_name: ["Jack", "anna", "hermine", "luc", "flora"].sample,
    last_name: ["Coulibaly", "yao", "kaye", "Meite", "sylla"].sample,
    sexe: ["masculin", "féminin"].sample,
    date: Time.now,
    birth_mode: ["Hôpital", "Maison"].sample,
    father_name: ["Jack nobert", "lucas yao", "kouadio konan", "kra dao", "lohoues k-jeol"].sample,
    mother_name: ["aicha sagafoua", "emma koffi", "bouabre dolores", "kone sali"].sample,
    location: ["allokro sud", "allakro nord"].sample
  )
end
